...
/*
These DAO interfaces define database access methods for CRUD operations
(Create, Read, Update, Delete) and data retrieval with Room Persistence Library in Android
development, utilizing Kotlin's coroutines and Flow for asynchronous data handling.
 */
@Dao
interface ItemDao{

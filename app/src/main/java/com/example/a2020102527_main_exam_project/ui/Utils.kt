package com.example.a2020102527_main_exam_project.ui
...
/*
The Utils object contains a list of predefined Category objects representing different categories.
Each Category has a title, an associated drawable resource ID (resId), and an ID.
 */
object Utils {
    val category = listOf(

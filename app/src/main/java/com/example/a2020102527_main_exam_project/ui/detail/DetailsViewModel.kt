...
This code defines a ViewModel class DetailsViewModel and a ViewModelFactory
class DetailViewModelFactor for managing UI-related data in the Details screen of an Android app.
 It handles interactions with the repository, updates the UI state, and provides functions to
 modify the state based on user actions.
 */
...
class DetailViewModelFactor(private val id: Int): ViewModelProvider.Factory{
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return DetailsViewModel(itemId = id) as T
    }
}
